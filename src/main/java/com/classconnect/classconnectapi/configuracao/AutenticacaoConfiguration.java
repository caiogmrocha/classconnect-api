        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
                return httpSecurity
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                .requestMatchers(HttpMethod.POST, "/api/perfis/login",
                                                                "/api/perfis/cadastrar")
                                                .permitAll()
                                                ...
                                                .authenticated()
                                                .requestMatchers(HttpMethod.POST,
                                                                "/api/salas/{iSala}/convidar/{idAluno}")
                                                .hasRole("PROFESSOR")
                                                .requestMatchers(HttpMethod.PATCH,
                                                                "/api/salas/{idSala}/aceitar/{idAluno}")
                                                .hasRole("PROFESSOR")
                                                .requestMatchers(HttpMethod.POST,
                                                                "/api/salas/{iSala}/matriculas/solicitar")
                                                .hasRole("ALUNO")
                                                .requestMatchers(HttpMethod.PATCH,
                                                                "/api/salas/{idSala}/matriculas/aceitar")
                                                .hasRole("ALUNO")
                                                .requestMatchers(HttpMethod.DELETE,
